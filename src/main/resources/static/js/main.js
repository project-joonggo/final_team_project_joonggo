...
// 슬라이드 6개_test
const slide6_test = new Swiper('#slide6_test', {
	...
	pagination : { // 페이징
		el : '#slide6_test .swiper-pagination',
		clickable : true, // 페이징을 클릭하면 해당 영역으로 이동, 필요시 지정해 줘야 기능 작동
	},
	navigation : { // 네비게이션
		nextEl : '#slide6_test .swiper-button-next', // 다음 버튼 클래스명
		prevEl : '#slide6_test .swiper-button-prev', // 이번 버튼 클래스명
	},
});