...
public class SocialLoginHandler {
    ...
    private static final String NAVER_REDIRECT_URI = "http://localhost:8089/user/naver/callback";
    ...
    private static final String GOOGLE_REDIRECT_URI = "http://localhost:8089/user/google/callback";
